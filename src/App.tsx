...
type ActiveSection = 'dashboard' | 'conversations' | 'ai-training' | 'whatsapp' | 'instagram' | 'calendar' | 'my-products' | 'pedidos' | 'meeting' | 'contacts' | 'cadastros' | 'settings' | 'profile' | 'support' | 'debug' | 'subscription';
    ...
    <Routes>
      ...
      <Route path="/google-calendar" element={
        <div className="flex h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
          <Sidebar activeSection="calendar" setActiveSection={setActiveSection} />
          <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <main className="flex-1 overflow-y-auto p-6">
              <GoogleCalendar addAppNotification={addAppNotification} />
            </main>
          </div>
        </div>
      } />
